...
export function HeroVisual({ className }: HeroVisualProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_35%_18%,rgba(212,175,55,0.28),transparent_55%)]" />
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_80%_0%,rgba(212,175,55,0.12),transparent_45%)]" />
